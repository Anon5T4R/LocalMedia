...
$fonte = @"
FFmpeg — binário de terceiro redistribuído com o LocalMedia
============================================================
...
LocalMedia não faz linkagem com as bibliotecas do FFmpeg: as duas obras são
apenas agregadas no mesmo instalador e cada uma mantém a sua licença — o
LocalMedia é MIT, o FFmpeg é GPL-3.0-or-later.
...
https://github.com/Anon5T4R/LocalMedia e ele será fornecido.
"@
